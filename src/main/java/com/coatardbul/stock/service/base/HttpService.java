...
@Autowired
     ...
     * @return
     */
    public  String doPost(String url, String jsonString, List<Header> headerList) throws NoSuchMethodException, ScriptException, FileNotFoundException {
        return doPost(url,jsonString,headerList,true);
    }



    public  String doPost(String url, String jsonString, List<Header> headerList,boolean isProxy) throws NoSuchMethodException, ScriptException, FileNotFoundException {
